    ...
    <div class="col-md-12">
        <div class="page-title">Department
            <span class="pull-right short-ico">
                ...
                <a href="<?php echo $this->Url->build(["controller" => "hrms-departments", "action" => "edit",$hrmsDepartment->id]); ?>"
                    title="Edit">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="text-md">Department Name</div>
                            <p class="m0"><?= h($hrmsDepartment->department_name) ?>
                            </p>
                        </div>
                    </div>
                </div>
