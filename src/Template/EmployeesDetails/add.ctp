        ...
        <div class="row">
            ...
            <section>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('date_of_birth', ['type' => 'text', 'label'=>false, 'class'=>'input-sm bg-gray form-control','empty'=>'Select DOB']); ?>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
            ...
            <section>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('start_date', ['label'=>false, 'type' => 'text', 'class'=>'input-sm bg-gray form-control','placeholder'=>'Select start date']); ?>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
                        End Date</label>
                    <div class="col-lg-8 col-md-8 col-xs-12 col-sm-9">
                        <?php echo $this->Form->control('end_date', ['label'=>false, 'type' => 'text', 'class'=>'input-sm bg-gray form-control','placeholder'=>'Select end date']); ?>
                    </div>
                </div>
                <div class="form-group col-md-4">
                    <label class="col-lg-3 col-md-3 col-sm-3 col-xs-12 control-label">
