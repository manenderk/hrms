...
<div class="row">
    <div class="col-md-12">
        <div class="page-title">ASSET CATEGORY
            <span class="pull-right short-ico">
                ...
                <a href="<?php echo $this->Url->build(["controller" => "hrms-asset-categories", "action" => "edit",$hrmsAssetCategory->id]); ?>"
                    title="Edit">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <p class="m0"><?= h($hrmsAssetCategory->category_name) ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="text-md">Category Description</div>
                            <p class="m0"><?= h($hrmsAssetCategory->category_description) ?>
                            </p>
